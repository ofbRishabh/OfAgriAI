...
import { Truck, Shield, Target, Users, MapPin, Calendar, PieChart, TrendingUp, Download, Filter } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-blue-100 flex flex-col">
      <header className="bg-blue-700 text-white px-8 py-5 shadow flex items-center gap-4">
        ...
        <h1 className="text-2xl font-bold tracking-tight flex-1">Procurement Dashboard</h1>
        <button className="bg-blue-600 hover:bg-blue-800 text-white px-3 py-1 rounded flex items-center gap-2" onClick={() => setFilterOpen(!filterOpen)}>
      ...
      <main className="flex-1 p-8 max-w-6xl mx-auto w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-white rounded-xl shadow p-5 flex flex-col items-center">
            <div className="text-2xl font-bold text-orange-700 mb-1">12,450</div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          <div className="bg-white rounded-xl shadow p-6">
            <div className="font-semibold text-blue-700 mb-3 flex items-center gap-2"><MapPin className="h-4 w-4" /> Regional Crop Arrivals</div>
            <div className="grid grid-cols-2 gap-4">
              {demoArrivals.map((r) => (
                <div key={r.region} className="bg-blue-50 rounded p-3 flex flex-col items-center">
        ...
        <div className="flex justify-center mt-8">
          <span className="inline-flex items-center gap-2 bg-blue-50 text-blue-800 px-3 py-1 rounded-full text-xs font-semibold border border-blue-200">
            <img src="/placeholder-logo.png" alt="OfBusiness" className="h-4 w-4 rounded bg-white border" />
            Powered by OfBusiness
          </span>
        </div>
      </main>
